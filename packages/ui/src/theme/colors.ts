...
const base = {
	...
	dark: {
		...
		"shadow.4": "0 20px 25px -5px rgba(0, 0, 0, 0.4), 0 10px 10px -5px rgba(0, 0, 0, 0.2)",
	},
} as const;
...
const semantic = (mode: "light" | "dark") => {
	...
	return {
		...
		"background.interactive": mode === "light" ? baseColors["blue.11"] : baseColors["blue.9"],
		...
		"background.input": mode === "light" ? baseColors.white : baseColors["gray.8"],
